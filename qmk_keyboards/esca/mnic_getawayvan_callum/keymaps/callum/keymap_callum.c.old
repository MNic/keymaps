...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_split_4space(
    ...
    KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,            KC_N,   KC_M, KC_COMM, KC_DOT,  KC_SLSH,
                   XXXXXXX, LA_NAV, KC_LSFT,            KC_SPACE, LA_SYM, XXXXXXX
  ),
  [_CDH] = LAYOUT_split_4space(
  ...
  [_SYM] = LAYOUT_split_4space(
    KC_ESC,    KC_LBRC,   KC_LCBR,   KC_LPRN,   KC_TILD,      KC_CIRC,  KC_RPRN,  KC_RCBR,  KC_RBRC, KC_GRAVE, XXXXXXX,
    KC_MINUS,  KC_ASTR,   KC_EQUAL,  KC_UNDS,  KC_DOLLAR,            KC_HASH,  OS_CMD,  OS_ALT,  OS_CTRL,  OS_SHFT,
    KC_PLUS,   KC_PIPE,   KC_AT,     KC_BSLS,   KC_PERCENT,           _______,  KC_AMPR,  KC_SCLN,  KC_COLN,  KC_EXLM,
                           XXXXXXX, _______,  _______,             _______, _______, XXXXXXX
  ),
  [_NAV] = LAYOUT_split_4space(
    KC_TAB,   _______,   _______,   _______,   KC_VOLU,    _______,  KC_HOME,  KC_PGUP,  _______,  KC_DEL, XXXXXXX,
    OS_SHFT,  OS_CTRL,   OS_ALT,   OS_CMD,   KC_VOLD,            KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT, KC_BSPC,
    _______,  _______,   KC_MPRV,   KC_MNXT,   KC_MPLY,            KC_CAPS,  KC_END,   KC_PGDN,  KC_PGUP,  KC_ENT,
                        XXXXXXX, _______,  _______,                      _______, _______, XXXXXXX
  ),
  [_NUM] = LAYOUT_split_4space(
    ...
    KC_F1,   KC_F2,   KC_F3,   KC_F4,     KC_F5,               KC_F6,    KC_F7,   KC_F8,    KC_F9,     KC_F12,
                             XXXXXXX,  _______,   MO(_RGB),            KC_SPACE, _______, XXXXXXX
  ),
  [_RGB] = LAYOUT_split_4space(
    TG(_CDH),  _______,  _______,  _______,  _______,     _______,  _______,    _______,  _______,  _______, QK_BOOT,
    RGB_TOG,  RGB_HUI,  RGB_SAI,  RGB_VAI,  _______,           _______,  _______,  _______,  _______,   _______,
    RGB_MOD,  RGB_HUD,  RGB_SAD,  RGB_VAD,  _______,           _______,    _______,  _______,   _______,  _______,
                                XXXXXXX, _______,  _______,           _______,  _______, XXXXXXX
  ),
};
// clang-format on
