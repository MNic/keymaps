...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ortho(
        ...
        MO(5),          MO(6),      KC_LALT,    KC_LGUI,    MO(3),      KC_SPC,     KC_SPC,     MO(2),      KC_ENT,     MO(6),      MO(5),                         KC_LEFT, KC_DOWN, KC_RGHT
    ),
    // Colemak Mod-DH
    [1] = LAYOUT_ortho(
    ...
    [2] = LAYOUT_ortho(
        ...
        _______,        _______,    _______,    KC_LGUI,    MO(4),      KC_SPC,     KC_SPC,     _______,      _______,    _______,    _______,                  _______, _______, _______
    ),
    // symbol
    [3] = LAYOUT_ortho(
    ...
    // Media controls
    [5] = LAYOUT_ortho(
        _______,        XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    KC_VOLU,    XXXXXXX,    XXXXXXX,    XXXXXXX,    KC_BRIU,     _______,
        _______,        XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    KC_MPRV,    KC_VOLD,    KC_MNXT,    XXXXXXX,    XXXXXXX,    KC_BRID,
        _______,        XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    KC_MPLY,     KC_MUTE,    KC_MSTP,    XXXXXXX,    XXXXXXX,                _______,
        TG(1),        _______,    TG(0),    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,                    _______, _______, _______
    ),
    // RGB
    [6] = LAYOUT_ortho(
        ...
        TG(1),        _______,    TG(0),    BL_OFF,     BL_DEC,     _______,    _______,    _______,    _______,    _______,    _______,                    _______, _______, _______
    ),
