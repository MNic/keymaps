...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NUM] = LAYOUT_split_4space(
    ...
    S(KC_SLSH),    S(KC_BSLS),    KC_QUOTE,    S(KC_QUOTE),    KC_WFWD,    KC_LEFT,    KC_DOWN,    KC_UP,    KC_RIGHT,    KC_PPLS,
  ...
  [SYM] = LAYOUT_split_4space(
    ...
    S(KC_GRV),    KC_GRV,    KC_BSLS,    S(KC_BSLS),    KC_TRNS,    KC_TRNS,    S(KC_MINS),    KC_EQL,    KC_TRNS,    C(KC_W),  
