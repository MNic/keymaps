...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( /* Qwerty */
    ...
    MO(5),       KC_LALT, KC_LGUI, LT(3, KC_SPC),        LT(2, KC_SPC), KC_ENT,  KC_RGUI, KC_RALT,    MO(5)
  ),
  [1] = LAYOUT( /* Colemak-DH */
    KC_GESC,   KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,    KC_J,    KC_L,    KC_U,    KC_Y,   KC_SCLN,  KC_BSPC,
    CTL_T(KC_TAB), KC_A,    KC_R,    KC_S,    KC_T,    KC_G,  KC_M,    KC_N,    KC_E,    KC_I, KC_O, KC_QUOT,
  ...
  [2] = LAYOUT( /* NUM */
    ...
    MO(5),       KC_LALT, KC_LGUI,        LT(4, KC_SPC), KC_TRNS,          KC_ENT,  KC_RGUI, KC_RALT,    MO(5)
  ),
  [3] = LAYOUT( /* SYM */
    ...
    MO(5),   KC_LALT, KC_LGUI,                  KC_TRNS, LT(4, KC_SPC),            KC_ENT,  KC_RGUI, KC_RALT,    MO(5)
  ),
  [4] = LAYOUT( /* WINDOWCTRL */
    ...
    MO(5),   KC_LALT, KC_LGUI,                  KC_TRNS, KC_TRNS,          KC_ENT,  KC_RGUI, KC_RALT,    MO(5)
  ),
  [5] = LAYOUT( /* RGB-VOL */
    RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI,   XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX, KC_VOLU, XXXXXXX, XXXXXXX,
    RGB_TOG, RGB_RMOD, RGB_HUD, RGB_SAD, RGB_VAD, BL_INC, XXXXXXX, XXXXXXX, KC_MPRV, KC_VOLD, KC_MNXT, XXXXXXX,
    BL_TOGG, BL_STEP, BL_BRTG,  BL_ON,  BL_OFF,   BL_DEC, XXXXXXX, XXXXXXX, KC_MPLY, KC_MUTE, KC_MSTP, XXXXXXX,
    MO(5),   KC_LALT, KC_LGUI,                  KC_TRNS, KC_TRNS,          KC_ENT,  KC_RGUI, KC_RALT,    MO(5)
  ),
  [6] = LAYOUT( /* RESET */
