...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( /* Qwerty */
    ...
    MO(5),       KC_LALT, KC_LGUI, MO(3),        KC_SPC, MO(2),  KC_LEFT, KC_DOWN,    KC_RIGHT
  ),
  [1] = LAYOUT( /* Colemak-DH */
  ...
  [2] = LAYOUT( /* NUM */
    ...
    KC_TRNS,       KC_TRNS, KC_TRNS,        MO(4), KC_TRNS,          KC_TRNS,  KC_TRNS, KC_TRNS,    KC_TRNS
  ),
  [3] = LAYOUT( /* SYM */
    ...
    KC_TRNS,   KC_TRNS, KC_TRNS,                  KC_TRNS, KC_SPC,   MO(4),  KC_TRNS, KC_TRNS,   KC_TRNS
  ),
  [4] = LAYOUT( /* WINDOWCTRL */
