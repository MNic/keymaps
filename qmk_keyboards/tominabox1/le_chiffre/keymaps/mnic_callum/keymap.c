...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_CDH] = LAYOUT(
    KC_Q,   KC_W,   KC_F,   KC_P,   KC_B,  KC_MPLY,  KC_J,   KC_L,    KC_U,   KC_Y,  KC_QUOTE,
    KC_A,   KC_R,   KC_S,   KC_T,   KC_G,            KC_M,   KC_N,    KC_E,   KC_I,  KC_O,
    KC_Z,   KC_X,   KC_C,   KC_D,   KC_V,            KC_K,   KC_H,    KC_COMM, KC_DOT,  KC_SLSH,
                         LA_NAV, KC_LSFT,            KC_SPACE, LA_SYM
  ),
  [_SYM] = LAYOUT(
    KC_ESC,    KC_LBRC,   KC_LCBR,   KC_LPRN,   KC_TILD,    _______,  KC_CIRC,  KC_RPRN,  KC_RCBR,  KC_RBRC, KC_GRAVE,
  ...
  [_NAV] = LAYOUT(
    KC_TAB,   _______,   _______,   _______,   KC_VOLU,  _______,  _______,  KC_HOME,  KC_PGUP,  _______,  KC_DEL,
  ...
  [_NUM] = LAYOUT(
    KC_1,    KC_2,    KC_3,    KC_4,      KC_5,     TG(_CDH),   KC_6,     KC_7,    KC_8,     KC_9,      KC_0,
    ...
    KC_F1,   KC_F2,   KC_F3,   KC_F4,     KC_F5,               KC_F6,    KC_F7,   KC_F8,    KC_F9,     KC_F12,
                               _______,   MO(_RGB),            KC_SPACE, _______
  ),
  [_RGB] = LAYOUT(
